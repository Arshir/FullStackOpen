...
describe('The blog with the most likes is the ',()=>{
 const expectedFavoriteBlog = 
 {
  ...
  test('is the favorite blog',()=>{
    const actualFavoriteBlog = listHelper.getFavouriteBlog(listWithManyBlogs)

    assert.deepStrictEqual(actualFavoriteBlog,expectedFavoriteBlog)
